...
type EditFloorplanFormProps = {
  projectId: string;
  floorplanId: string;
  initialTitle: string;
  initialFloorName: string | null;
  locale: AppLocale;
  action: (formData: FormData) => Promise<void>;
};

export function EditFloorplanForm({
  projectId,
  floorplanId,
  initialTitle,
  initialFloorName,
  ...
  const copy =
    locale === "el"
      ? {
          cancel: "Ακύρωση",
          edit: "Επεξεργασία",
          fallbackError: "Δεν ήταν δυνατή η ενημέρωση κάτοψης",
      ...
      : {
          cancel: "Cancel",
          edit: "Edit",
          fallbackError: "Could not update floorplan",
